...
const vendasMensais = [
  { name: "Jul", vendas: 45000 },
  { name: "Ago", vendas: 52000 },
  { name: "Set", vendas: 48000 },
  { name: "Out", vendas: 61000 },
  { name: "Nov", vendas: 55000 },
  { name: "Dez", vendas: 78000 },
  { name: "Jan", vendas: 42000 },
];

const formasPagamento = [
  { name: "Cartão", value: 45, color: "hsl(222 47% 20%)" },
  { name: "Dinheiro", value: 25, color: "hsl(160 84% 39%)" },
  { name: "PIX", value: 22, color: "hsl(199 89% 48%)" },
  { name: "Crediário", value: 8, color: "hsl(38 92% 50%)" },
];

const topProdutos = [
  { name: "Arroz Integral 5kg", quantidade: 450, valor: 11205.0 },
  { name: "Feijão Carioca 1kg", quantidade: 380, valor: 3230.0 },
  { name: "Leite Integral 1L", quantidade: 520, valor: 3068.0 },
  { name: "Café Torrado 500g", quantidade: 280, valor: 4452.0 },
  { name: "Açúcar Refinado 1kg", quantidade: 340, valor: 1530.0 },
];
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {relatoriosDisponiveis.map((relatorio, index) => (
            <button
              key={relatorio.title}
              className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border/50 shadow-card hover:border-primary hover:shadow-md transition-all text-left animate-fade-in"
